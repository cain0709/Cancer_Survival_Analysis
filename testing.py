...
class Trainer():
	...
	def validation(self, eval_model):
		...
		return ev.concordance_td(method='antolini'), np.mean(val_loss)
...
if __name__ == '__main__':
	...
	if args.EDA is True:
		...
		#df.replace({'N': 0, 'Y': 1, 'Unknown' : 0.5, 'M' : 0, 'F' : 1}, inplace = True)
		...
		print(corr)
		print(corr.loc[abs(corr['duration'])>0.1, 'duration'])
		print(corr.loc[abs(corr['dead'])>0.1, 'dead'])

		print(df.loc[df['treatech']!=df['treatech'],'cancerimagingM'].value_counts())
		print(df.loc[df['treatech']!=df['treatech'],'cancerimagingN'].value_counts())
		print(df.loc[df['treatech']!=df['treatech'],'cancerimagingT'].value_counts())
		print("CANCERIMAGING-M")
		print(df.loc[df['treatech']==1,'cancerimagingM'].value_counts())
		print(df.loc[df['treatech']==2,'cancerimagingM'].value_counts())
		print(df.loc[df['treatech']==3,'cancerimagingM'].value_counts())
		print(df.loc[df['treatech']==4,'cancerimagingM'].value_counts())
		print("CANCERIMAGING-N")
		print(df.loc[df['treatech']==1,'cancerimagingN'].value_counts())
		print(df.loc[df['treatech']==2,'cancerimagingN'].value_counts())
		print(df.loc[df['treatech']==3,'cancerimagingN'].value_counts())
		print(df.loc[df['treatech']==4,'cancerimagingN'].value_counts())
		print("CANCERIMAGING-T")
		print(df.loc[df['treatech']==1,'cancerimagingT'].value_counts())
		print(df.loc[df['treatech']==2,'cancerimagingT'].value_counts())
		print(df.loc[df['treatech']==3,'cancerimagingT'].value_counts())
		print(df.loc[df['treatech']==4,'cancerimagingT'].value_counts())

		print("locationcancer")
		print(df.loc[df['treatech']==1,'locationcancer'].value_counts())
		print(df.loc[df['treatech']==2,'locationcancer'].value_counts())
		print(df.loc[df['treatech']==3,'locationcancer'].value_counts())
		print(df.loc[df['treatech']==4,'locationcancer'].value_counts())

		print("relapse")
		print(df.loc[df['treatech']==1,'relapse'].value_counts())
		print(df.loc[df['treatech']==2,'relapse'].value_counts())
		print(df.loc[df['treatech']==3,'relapse'].value_counts())
		print(df.loc[df['treatech']==4,'relapse'].value_counts())
		'''print("###")
	...
	df_train, df_val = train_test_split(df, test_size = 0.01, stratify = df['dead'], random_state=SEED)
	...
	if args.Train is True:
		...
		print("c-index : " , ev.concordance_td(method='antolini'))
	...
	if args.Predict is True:
		...
		test_df.replace({'N': 0, 'Y': 1, 'Unknown' : 0.5, 'M' : 0, 'F' : 1}, inplace = True)
		...
		ss.fillna(method = 'bfill',inplace = True)
		ev = EvalSurv(ss, val_y[0], val_y[1], censor_surv='km')
		print("C-index : " + str(ev.concordance_td(method='antolini')))
